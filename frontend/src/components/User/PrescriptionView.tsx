    ...
    return (
      <div className="max-w-4xl mx-auto p-4">
        <div className="bg-red-50 border border-red-200 rounded-lg p-6 text-center">
          <h2 className="text-xl font-semibold text-red-600 mb-2">Error Loading Prescription</h2>
    ...
    return (
      <div className="max-w-4xl mx-auto p-4">
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 text-center">
          <h2 className="text-xl font-semibold text-blue-600 mb-2">Prescription Not Found</h2>
          <p className="text-gray-600 mb-4">The requested prescription does not exist or you don't have access to it.</p>
    ...
    <div className="max-w-6xl mx-auto p-4 md:p-6">
      ...
      >
        ...
        <div className="text-center border-b pb-6">
          ...
          <Badge variant="outline" className="mt-4 text-indigo-600 border-indigo-600">
            <FaCalendarAlt />
            <span>
