...
class ReviewRepository implements IReviewRepository {
  ...
  async findReviewByDoctorAndPatient(doctorId: string, userId: string): Promise<IReview | null> {
  ...
  async findReviewByAppointment(appointmentId: string): Promise<IReview | null> {
