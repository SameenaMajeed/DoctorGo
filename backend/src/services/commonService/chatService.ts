...
export class ChatService {
  ...
  async getUsersWhoMessaged(
    doctorId: string
  ): Promise<
    { id: string; name: string; mobile_no?: string; profilePicture?: string }[]
  > {
    try {
  ...
  async getDoctorsWhoMessaged(
    userId: string
  ): Promise<{ id: string; name: string; profilePicture?: string }[]> {
    try {
